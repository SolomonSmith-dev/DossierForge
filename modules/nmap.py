...
def parse_host_element(host):
    ...
    """
    host_data = {"addresses": [], "ports": [], "os_info": {}, "status": "unknown"}
    ...
    for addr in host.findall(".//address"):
        ...
        if addr_type and addr_value:
            host_data["addresses"].append({"type": addr_type, "address": addr_value})
...
def get_nmap_summary(dossier_path):
    ...
    """
    summary = {"scans": [], "total_hosts": 0, "total_ports": 0, "open_ports": 0}
                            ...
                            open_ports.append(
                                {
                                    ...
                                    "product": port.get("service", {}).get(
                                        "product", ""
                                    ),
                                    "version": port.get("service", {}).get(
                                        "version", ""
                                    ),
